...
def callback(point_cloud):
    ...
    known_point1_index = 73  # Índice do primeiro ponto na nuvem de pontos
    known_point2_index = 212  # Índice do segundo ponto na nuvem de pontos

    real_distance = 2.5  # Distância real entre os dois pontos no mundo real (em metros)
